    ...
    <Card className="w-full max-w-md mx-auto">
      <CardContent className="p-6">
        ...
        <div className="mb-6 space-y-4">
          {/* InsureAutoFlow 카드 */}
          <Card className="relative overflow-hidden bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200 shadow-lg hover:shadow-xl transition-shadow cursor-pointer group">
            <a
            ...
            >
              ...
              <CardContent className="relative p-4">
                <div className="flex items-center mb-3">
                  ...
                  <h3 className="text-xl font-bold text-purple-800">InsureAutoFlow</h3>
                </div>
          ...
          {/* Life Matrix Flow 카드 */}
          <Card className="relative overflow-hidden bg-gradient-to-br from-pink-50 to-pink-100 border-pink-200 shadow-lg hover:shadow-xl transition-shadow">
            <div className="absolute inset-0 opacity-10">
            ...
            <CardContent className="relative p-4">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-xl font-bold text-pink-800">Life Matrix Flow</h3>
              </div>
              <p className="text-pink-700 text-sm mb-3">
                생명보험의 보험료 산출 자동화 플랫폼
              </p>
              <div className="space-y-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center w-full px-3 py-2 bg-pink-500 text-white font-semibold rounded-lg hover:bg-pink-600 transition-colors text-sm"
                >
                  <span>바로가기 (Cloud Run)</span>
                  <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                  </svg>
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center w-full px-3 py-2 bg-pink-400 text-white font-semibold rounded-lg hover:bg-pink-500 transition-colors text-sm"
                >
                  <span>바로가기 (Vercel)</span>
                  <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                  </svg>
                </a>
