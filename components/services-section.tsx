  ...
  return (
    <section id="services" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div id="services-title" className="text-center mb-16 scroll-mt-32">
          <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">
            보험 배움 마당
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            실무 중심의 보험 데이터 분석 및 모델링 교육 과정을 통해 전문성을
            향상시키세요.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
          {courses.map((course, index) => (
            <Card
              key={index}
              className="group hover:shadow-lg transition-all duration-300 hover:scale-105 flex flex-col"
            >
        ...
        <div id="community" className="bg-card rounded-lg p-8 scroll-mt-32">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              동료들과 함께 학습하고 실무 경험을 공유할 수 있는 온라인
              커뮤니티에 참여하세요.
            </p>
          </div>
