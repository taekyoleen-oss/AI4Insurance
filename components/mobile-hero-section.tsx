...
import { MobileLinksCard } from "./mobile-links-card";
      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto text-pretty">
            인공지능과 머신러닝으로 보험업계를 혁신하세요. 실시간 데이터
            분석부터 예측 모델링까지, 차세대 보험 전문가가 되기 위한 모든 것을
            제공합니다.
          </p>
        </div>

        {/* PC용 3개 카드 - 모바일에서도 동일하게 표시 */}
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center group hover:scale-105 transition-transform duration-300">
            ...
            <p className="text-muted-foreground">
              보험업계에 특화된 통계 분석 기법과 방법론을 통해 정확한 리스크
              평가와 프라이싱을 수행합니다.
            </p>
          </div>
          <div className="text-center group hover:scale-105 transition-transform duration-300">
            ...
            <p className="text-muted-foreground">
              건강보험 데이터와 의료 정보를 활용한 개인별 건강 위험도 평가 및
              맞춤형 보험 상품 개발을 지원합니다.
            </p>
          </div>
          <div className="text-center group hover:scale-105 transition-transform duration-300">
            ...
            <p className="text-muted-foreground">
              최신 AI 기술과 고급 분석 기법을 도입하여 보험업계의 데이터
              활용도와 의사결정 정확성을 혁신적으로 향상시킵니다.
            </p>
          </div>
        </div>

        {/* 모바일용 Linktree 스타일 카드들 */}
